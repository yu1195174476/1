        ...
        <div class="row trx-table--main-container">
            <div class="row col-12 q-mt-lg">
                ...
                <div v-if="filtersEnabled" class="col trx-table--topright-col">
                        ...
                        <div class="col-auto row flex trx-table--filter-buttons">
                            ...
                            >
                                <div class="q-pa-md dropdown-filter">
                                    <div class="row">
                                        <AccountSearch v-model="accountsModel"
                            ...
                            <q-btn-dropdown class="q-ml-xs q-mr-xs button-primary q-btn--no-text-transform"
                                        ...
                                        >
                                            ...
                                            <template v-slot:append>
                                                <q-icon class="cursor-pointer" name="access_time">
                                                    <q-popup-proxy cover="cover" transition-show="scale"
                                                                   transition-hide="scale"
                                                    >
                                                        <q-time v-model="fromDateModel" mask="YYYY-MM-DD HH:mm"
                                                                format24h
                                                        >
                                                            <div class="row items-center justify-end">
                                                                <q-btn
                            ...
                            >
                                <div class="q-pa-md dropdown-filter">
                                    <div class="row">
                                        <TokenSearch v-model="tokenModel"
                    ...
                    <div v-if="showPaginationExtras" class="row justify-end">
                        Viewing {{ paginationSettings.rowsPerPage > totalRows ? totalRows :
            ...
            <div class="row col-12 items-center justify-end q-mt-md q-mb-sm">
                ...
                <div class="col-auto">
                    ...
                    <q-icon :name="showPagesSizes ? 'expand_more' : 'expand_less'" size="sm"
    ...
    setup(props) {
        ...
        const loadTableData = async (): Promise<void> => {
            ...
            if (isTransaction.value) {
                ...
                let extras: {
                    [key: string]: string
                } | null = tokenModel.value ? { 'act.account': tokenModel.value.contract } : null;
                if (actionsModel.value) {
                    extras = extras ? {
                        ...extras,
