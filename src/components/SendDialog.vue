<template>
    ...
    >
        <q-card class="sendCard">
                ...
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-6 max-dialog-width">
                    ...
                    <div v-if="transactionForm" class="transaction-form text-grey-3 text-weight-light">
                        ...
                        <q-card-section v-if="transactionForm">
                            <div class="row">
                                <div class="col-12">
                                    <div class="row justify-between q-px-sm q-pb-sm q-gutter-x-sm">RECEIVING ACCOUNT
                                    </div>
                                    <q-input
                            ...
                            <div class="row q-py-md">
                                <div class="col-4">
                                    ...
                                    <div class="row items-center no-wrap selector-container q-py-sm"
                                         @click="openCoinDialog = true"
                                    >
                                ...
                                <div class="col-8 q-pl-md">
                                    <div class="row justify-between q-pb-sm q-gutter-x-sm">
                                        ...
                                        <div class="row flex-center q-hoverable cursor-pointer" @click="setMaxValue">
                                            <div class="color-grey-3 text-weight-bold balance-amount">{{
                                                `${sendToken?.amount ?? 0 } AVAILABLE` }}
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 q-pt-md">
                                    <div class="row justify-between q-px-sm q-pb-lg q-gutter-x-sm">Your wallet must be
                                        open to allow authorization of this transaction.
                                    </div>
                                    <q-btn
                    ...
                    <div v-else class="transaction-result">
                        <q-card-section v-if="transactionId">
                            <div class="row">
                                <div class="col-12">
                                    <div>You successfully sent {{ sendAmount }} {{ sendToken?.symbol }} to {{
                                        receivingAccount }}.
                                    </div>
                                </div>
                                <div class="col-12">
                                    Click to view transaction:
                                    <a class="ellipsis-overflow text-blue" @click="navToTransaction">{{ transactionId
                                        }}</a>
                                </div>
                            </div>
                        </q-card-section>
            ...
            <CoinSelectorDialog v-model="openCoinDialog" :updateSelectedCoin="updateSelectedCoin"
