            ...
            <q-card-section class="full-height row justify-center items-center">
                <div class="proposal-success__section-wrapper">
                    <header class="q-mb-lg">
                        ...
                        <span class="text-h4 text-white inline-block vertical-middle q-mb-md"
                        >Proposal sent successfully</span>
                    </header>
                    <p class="text-h6 text-white q-ma-none q-mb-xl">
                        ...
                        and transaction at
                        <router-link :to="'/transaction/' + transactionId"
                                     class="text-primary text-white cursor-pointer"
                        >
                            {{ transactionId }}
                        </router-link>
                    </p>
