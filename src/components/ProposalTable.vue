        ...
        <template v-slot:body="props">
            <q-tr :props="props">
                <q-td key="proposalName" :props="props">
                    <router-link class="text-primary cursor-pointer text-no-decoration"
                                 :to="'/proposal/' + props.row.proposalName"
                    >{{props.row.proposalName}}
                    </router-link>
                </q-td>
                <q-td key="approvalStatus" :props="props"><span>{{ props.row.approvalStatus }}</span></q-td>
                <q-td key="proposer" :props="props">
                    <router-link class="text-primary cursor-pointer text-no-decoration"
                                 :to="'/account/' + props.row.proposer"
                    >{{props.row.proposer}}
                    </router-link>
                </q-td>
                <q-td key="executed" :props="props">
                    <q-badge :color="props.row.executed ? 'green' : 'orange'"
                             :label="props.row.executed ? 'EXECUTED' : 'NOT EXECUTED'"
                    />
                </q-td>
            </q-tr>
        </template>
