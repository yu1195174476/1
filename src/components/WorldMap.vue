...
<template>
    ...
    <div class="ol-popup" id="popup" ref="popup"><a class="ol-popup-closer" href="#" id="popup-closer"
                                                    ref="popup-closer" v-show="$q.platform.is.mobile"
    ></a>
        <div id="popup-content" ref="popup-content"></div>
    </div>
    <div class="ol-popup" id="producerPopup" ref="producerPopup"><a class="ol-popup-closer" href="#"
                                                                    id="producerPopup-closer" ref="producerPopup-closer"
    ></a>
