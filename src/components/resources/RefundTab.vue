                    ...
                    <div class="row q-pt-sm">
                        <div class="col-7 q-pt-sm">Refund
                            <q-icon class="q-ml-xs" name="far fa-question-circle">
                                <q-tooltip class="bg-deep-purple-12" anchor="top middle" self="center middle">If it
                                    has been more than 72 hours since your unstake transaction. Click on Refund to
                                    claim your tokens.
                                </q-tooltip>
                            </q-icon>
                        </div>
