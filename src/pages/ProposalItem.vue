<template>
    <div class="proposal-item full-width row justify-center items-center header-support">
        ...
        <div v-else class="proposal-item__content col text-center">
            ...
            <p class="proposal-item__content-sub text-caption text-white text-uppercase q-mt-xs">PROPOSER
                <router-link :to="'/account/' + proposer" class="text-white cursor-pointer">{{proposer}}</router-link>
                • APPROVAL STATUS {{approvalStatus}} • EXPIRATION {{expirationDate}}
            </p>
            <div class="q-mb-lg">
    ...
    <q-page padding>
        ...
        <q-card v-for="(multsigTransactionItem, multsigTransactionIndex) in multsigTransactionData"
                :key="multsigTransactionIndex" class="q-mt-md"
        >
        ...
        <h2 class="text-h6 text-weight-regular q-mt-xl"><span>Requested Approvals</span><span
            class="text-body1 q-ml-sm text-grey"
        >{{approvalStatus}}</span><span class="q-mx-sm">•</span><span>Active BPs</span><span
            class="text-body1 q-ml-sm text-grey"
        >{{producersApprovalStatus}}</span></h2>
                ...
                <template v-slot:body="props">
                    <q-tr :props="props">
                        <q-td key="actor" :props="props">
                            <router-link class="text-primary text-no-decoration cursor-pointer"
                        ...
                        <q-td key="status" :props="props">
                            <q-badge :color="props.row.status ? 'green' : 'orange'"
