        ...
        <div class="row q-col-gutter-md q-pt-md container-max-width">
                    ...
                    <q-card-section>
                        ...
                        <div class="row q-pa-md">
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-6">{{ amount_voted.toLocaleString(undefined, {minimumFractionDigits:
                                        4,maximumFractionDigits: 4,}) }}
                                    </div>
                                    <div class="col-6">
                                        <div class="float-right">{{ supply.toLocaleString(undefined,
            ...
            <div v-if="accountValid" class="col-md-4 col-sm-12 col-xs-12">
                <q-card>
                    <q-card-section>
                        <div class="row full-width justify-center">
                            ...
                            <q-icon
                                ...
                                size="20px"
                            >
                                <q-tooltip anchor="top middle" self="bottom middle" :offset="[10, 10]">Voting is
                                    inversley weighted and increases the more validators you vote for (up to 30).
                                </q-tooltip>
                            </q-icon>
                        </div>
                        <div class="row full-width justify-center text-h5">{{ balance }}</div>
                        <div class="row full-width justify-center text-h6 q-py-md text-weight-regular text-grey">
                            {{account}}
                        </div>
                    </q-card-section>
                    <q-separator/>
                    <q-card-section>
                        <div
                            class="row full-width justify-center subtitle2 q-py-md text-weight-regular text-grey q-pt-lg"
                        >SELECTED {{currentVote.length}} BLOCK PRODUCERS
                        </div>
                        <div class="row full-width justify-center">
                            <q-btn
                ...
                <q-card class="full-height">
                    <q-card-section class="full-height">
                        <div class="column justify-center full-height">
                            <div class="row">
                                <div class="col-12 subtitle2 q-pb-md text-weight-regular text-grey q-pt-lg text-center">
                                    SELECTED {{currentVote.length}} BLOCK PRODUCERS
                                </div>
                                <div class="col-12">
                                    <q-btn
