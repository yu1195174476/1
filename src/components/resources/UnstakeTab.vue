            ...
            <div class="row q-pb-md">
                <div class="col-6">
                    <div class="row q-pb-sm">
                        ...
                        <div class="col-6">
                            <div class="color-grey-3 flex justify-end items-center"
                                 @click="cpuTokens = cpuStake.toString()"
                            >
                ...
                <div class="col-6 q-pl-md">
                    <div class="row q-pb-sm">
                        ...
                        <div class="col-6">
                            <div class="color-grey-3 flex justify-end items-center"
                                 @click="netTokens = netStake.toString()"
                            >
...
export default defineComponent({
    ...
    setup() {
        ...
        const selectModel = ref<{ label: string, value: DelegatedResources }>({
            label: '',
            value: null,
        });
