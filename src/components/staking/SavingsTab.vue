                ...
                <div class="col-12">
                    <div class="row">
                        <div class="row q-pb-sm full-width">
                            ...
                            <div class="col-3">
                                <div class="row items-center justify-end q-hoverable cursor-pointer"
                                     @click="setMaxSavingsValue"
                                >
                                    <div class="text-weight-bold text-right balance-amount">{{ eligibleStaked }}</div>
                                    <q-icon class="q-ml-xs" name="info"/>
                                    <q-tooltip>Any balance currently maturing will be moved first, click to stake full
                                        amount
                                    </q-tooltip>
                                </div>
                            </div>
