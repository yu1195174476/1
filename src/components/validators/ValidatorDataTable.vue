                        ...
                        <div class="q-card-section">
                            <div class="row">
                                <div class="col-1 q-py-md">
                                    <div class="row items-center full-height text-h6 q-px-md">{{producerRows.indexOf(bp)
                                        + 1}}
                                    </div>
                                </div>
                                <div class="col-3 q-py-md"><a class="hover-dec" :href=" '/account/' + bp.owner">
                                    <div class="text-uppercase text-h6 text-black">{{ bp.name|| bp.owner }}</div>
                                </a>
                                ...
                                <div class="col-2 q-py-md">
                                    <div class="row items-center full-height">{{ (bp.total_votes /
                                        10000).toLocaleString(undefined, {minimumFractionDigits:
                                        4,maximumFractionDigits: 4,}) }}
                                    </div>
                                </div>
                                <div class="col-2 q-py-md">
                                    <div class="row items-center full-height">{{ ((producerRows.indexOf(bp) + 1) < 22 ?
                                        producerPay : (producerRows.indexOf(bp) + 1) < 43 ? producerPay / 2 : 0
                                        ).toFixed(0) + ` ${symbol}` }}
                                    </div>
                                </div>
